...
<body style="background-color: #D0F2E0;">
	...
	<form name="nombreForm"
		action="ServletController?eleccion=upDateEmpleado&menuApp=buscaPagina" method="post">
			...
			<tbody>
				...
				<tr>
					...
					<td><input type="text" id="nombre" name="nombre"
						value=<%=oEmpleadoEncontrado.getsNombre()%> placeholder="Nombre:"
				...
				<tr>
					...
					<td><input type="text" id="dni" name="dni" placeholder="dni"
						value=<%=oEmpleadoEncontrado.getsDni()%>
				...
				<tr>
					...
					<td><input type="text" id="sexo" name="sexo"
						placeholder="Letra H o M"
						value=<%=oEmpleadoEncontrado.getcLetra()%>
				...
				<tr>
					...
					<td><input type="text" id="categoria" name="categoria"
						value=<%=oEmpleadoEncontrado.getbCategoria()%>
				...
				<tr>
					...
					<td><input type="text" id="anio" name="anio"
						value=<%=oEmpleadoEncontrado.getbAnyosTrabajados()%>
						placeholder="Anio/s:"
